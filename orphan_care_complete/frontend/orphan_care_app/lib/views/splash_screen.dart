...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
      ...
      _dotAnimations.add(
        Tween<double>(begin: 0.2, end: 1.0).animate(
          CurvedAnimation(
            ...
            curve: Interval(reverseIndex * 0.25, 0.5 + (reverseIndex * 0.25), curve: Curves.easeInOut),
          ),
        ),
      );
    }
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          PageRouteBuilder(
            ...
            transitionDuration: const Duration(milliseconds: 1100), // ثانية ومئة جزء لضمان تداخل لوني ناعم وسينمائي
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white, // 1. تعديل لون الخلفية ليكون أبيض ناصع وصافي
      body: SafeArea(
        child: Center(
              ...
              children: [
                ...
                ScaleTransition(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Colors.white, // خلفية بيضاء للدائرة ليبرز الشعار بداخلها
                      boxShadow: [
                        BoxShadow(
                          color: Colors.black.withOpacity(0.06),
                          blurRadius: 24,
                          offset: const Offset(0, 12), // إيحاء بالارتفاع عن الشاشة
                        ),
                        BoxShadow(
                    ...
                    child: ClipRRect(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(20.0), // مسافة أمان (Padding) لكي لا تلمس أطراف الـ logo الدائرة
                        child: Image.asset(
                          'assets/images/logo.png',
                          fit: BoxFit.contain, // يضمن عدم تمطط أو تشوه أبعاد الشعار
                ...
                const Text(
                  ...
                  style: TextStyle(
                    ...
                    color: AppColors.brandOrange, // تعديل اللون للبرتقالي لبروز مثالي فوق الأبيض
                    letterSpacing: 0,
                  ),
                ),
                ...
                const Text(
                  'نربط القلوب؛ لنصنع الأثر',
                  style: TextStyle(
                    fontFamily: 'Cairo',
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                    color: AppColors.textDarkSecondary, // متناسق تماماً مع الهوية والقراءة
                  ),
                ),
                        ...
                        return Opacity(
                          ...
                          child: Container(
                            ...
                            decoration: const BoxDecoration(
                              shape: BoxShape.circle,
                              color: AppColors.brandOrange, // تومض بالبرتقالي لتعطي حيوية مبهجة للواجهة
                            ),
                          ),
                        );
                      }),
